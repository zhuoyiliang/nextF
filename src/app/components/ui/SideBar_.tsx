    ...
    return (
        <>
            <aside className="flex">
                <div
                    className="flex flex-col items-center w-16 h-screen py-8 bg-white dark:bg-gray-900 dark:border-gray-700 border-r md:border-r-0  max-sm:hidden">
                    <nav className="flex flex-col items-center flex-1 space-y-8 ">
                        <Link href="/">
                            <img className="w-auto h-6 hover:scale-125 ease-in-out transition-transform" src="https://merakiui.com/images/logo.svg" alt=""/>
                        </Link>

                        <Link href="/"
                           className="hover:scale-125 ease-in-out transition-transform  p-1.5 inline-block text-gray-500 focus:outline-nones  duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
                ...
                <div
                    className="h-screen px-5 py-8 overflow-y-auto bg-white border-l border-r w-60 max-md:hidden dark:bg-gray-900 dark:border-gray-700 ">
                    ...
                    <nav className="mt-4 -mx-3 space-y-6 ">
                        <div className="space-y-3 ">
                            ...
                            <Link
                                ...
                                <span className="mx-2 text-sm font-medium">文件上传</span>
                            </Link>
                            ...
                            <Link className="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
                               href="/api/test">
                                ...
                                <span className="mx-2 text-sm font-medium">测试</span>
                            </Link>
                        </div>
